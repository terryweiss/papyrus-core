...
var Schema = Base.compose( [Base], /** @lends documents/schema# */{
	...
	/**
	 * Attach the validator so that the extract and validate methods are bound to the instance
	 * @param obj
	 */
	attachTo      : function ( obj ) {
		this.extract = sys.partial( this.extract, obj );
		this.validate = sys.partial( this.validate, obj );
	}
} );
